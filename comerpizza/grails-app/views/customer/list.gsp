			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="mobilePhone" title="${message(code: 'customer.mobilePhone.label', default: 'Mobile Phone')}" />
				...
				<g:each in="${customerInstanceList}" status="i" var="customerInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: customerInstance, field: "mobilePhone")}</td>
