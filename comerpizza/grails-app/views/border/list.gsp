...
<html>
	...
	<body>
		<a href="#list-border" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-border" class="content scaffold-list" role="main">
			...
			<table>
				...
				<tbody>
				<g:each in="${borderInstanceList}" status="i" var="borderInstance">
			...
			<div class="pagination">
				<g:paginate total="${borderInstanceTotal}" />
			</div>
		</div>
	</body>
</html>
