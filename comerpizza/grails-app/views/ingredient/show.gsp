	...
	<body>
		...
		<div id="show-ingredient" class="content scaffold-show" role="main">
			...
			<ol class="property-list ingredient">
				...
				<g:if test="${ingredientInstance?.isActive}">
				<li class="fieldcontain">
					<span id="isActive-label" class="property-label"><g:message code="ingredient.isActive.label" default="Is Active" /></span>
					
						<span class="property-value" aria-labelledby="isActive-label"><g:formatBoolean boolean="${ingredientInstance?.isActive}" /></span>
					
				</li>
				</g:if>
			
				<g:if test="${ingredientInstance?.isHidden}">
				<li class="fieldcontain">
					<span id="isHidden-label" class="property-label"><g:message code="ingredient.isHidden.label" default="Is Hidden" /></span>
					
						<span class="property-value" aria-labelledby="isHidden-label"><g:formatBoolean boolean="${ingredientInstance?.isHidden}" /></span>
